                ...
                <div class="row">
                    ...
                    <div class="field">
                        ...
                        <input type="number" id="course-price" name="course_price" step="0.00" 
                            value="<?= htmlspecialchars($curso['costo'] ?? 0); ?>" required>
                    </div>
                    <div class="field">
                        ...
                        <div class="level">
                            ...
                            <div class="field">
                                ...
                                <input type="text" id="level_title_<?= $index; ?>" 
                                    ...
                                    value="<?= htmlspecialchars($nivel['titulo_nivel'] ?? ''); ?>" required>
                            </div>
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <input type="number" id="level_price_<?= $index; ?>" 
                                    ...
                                    value="<?= htmlspecialchars($nivel['costo'] ?? 0); ?>" step="0.01" required>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
